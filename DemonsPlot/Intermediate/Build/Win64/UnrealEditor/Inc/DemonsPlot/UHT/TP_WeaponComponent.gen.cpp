...
#include "DemonsPlot/TP_WeaponComponent.h"
...
// Cross Module References
	...
	DEMONSPLOT_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
	DEMONSPLOT_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ADemonsPlotCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			ADemonsPlotCharacter* TargetCharacter;
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 1429698699
	...
	template<> DEMONSPLOT_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	UTP_WeaponComponent::~UTP_WeaponComponent() {}
	struct Z_CompiledInDeferFile_FID_dev_demons_plot_DemonsPlot_Source_DemonsPlot_TP_WeaponComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_dev_demons_plot_DemonsPlot_Source_DemonsPlot_TP_WeaponComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 630707839U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_dev_demons_plot_DemonsPlot_Source_DemonsPlot_TP_WeaponComponent_h_2878483147(TEXT("/Script/DemonsPlot"),
		Z_CompiledInDeferFile_FID_dev_demons_plot_DemonsPlot_Source_DemonsPlot_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_dev_demons_plot_DemonsPlot_Source_DemonsPlot_TP_WeaponComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
